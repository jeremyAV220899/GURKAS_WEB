                            ...
                            <div class="border p-3 rounded">
                                ...
                                <form id="formulario" class="row g-3" method="POST" action="{{ route('brevete.store') }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="descripcionBrevete" name="descripcionBrevete" class="form-control"
                                            required>
                                    </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5">
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="bttablaBrevete" class="table table-striped table-bordered dataTable" role="grid"
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                                <button class="btn text-warning btnEditar" type="button" data-id="{{ $brevete->id }}" data-bs-toggle="modal" data-bs-target="#registrar">
                                                    <i class="bi bi-pencil-fill">
                                                    </i>
                                                </button>
                                                <button class="btn text-danger btnBorrar" title="Eliminar" type="button" data-id="{{ $brevete->id }}">
