        ...
        <div class="card-body">
            <div class="table-responsive">
                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5">
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="tablaGrado" class="table table-striped table-bordered dataTable" role="grid"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            style="width: 50.094px;">Grado de Instrucción</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                                    <button class="btn text-warning btnEditar" type="button" data-id="{{ $grado->id }}" data-bs-toggle="modal" data-bs-target="#registrar">
                                                        <i class="bi bi-pencil-fill">
                                                        </i>
                                                    </button>
                                                    <button class="btn text-danger btnBorrar" title="Eliminar" type="button" data-id="{{ $grado->id }}">
