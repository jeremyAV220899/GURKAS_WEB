...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title titulo">Registrar Estado</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="border p-3 rounded">
                                <h6 class="mb-0 text-uppercase">Datos de Estado</h6>
                                <hr />
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <button type="button" class="btn btn-primary btnCrearEstado" data-bs-toggle="modal"
                    data-bs-target="#registrar">Registrar
                    Nuevo</button>
            </div>
        </div>
    </div>
    <h6 class="mb-0 text-uppercase">Lita de Estados</h6>
    <hr>
    <div class="card">
        <div class="card-body">
...
@section('script')
    <script type="text/javascript">
        $('.btnCrearEstado').click(function() {
            let val_url = '/administrador/sistemas/estados/guardar';
            $('.titulo').html('Registrar Estado');
        ...
        $('.tablaEstado').on('click', '.btnEditar', function() {
            ...
            $.get(val_url, function(res) {
                $('.titulo').html('Editar Estado');
                $('.btnRegistrar').html('Editar');
                $('#nombre').val(res.estado.nombre);
                $('#formulario').attr('action', '/administrador/sistemas/estados/actualizar/' + val_id);
                $('#registrar').modal('show');
            });
        });
