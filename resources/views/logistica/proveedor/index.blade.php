...
@section('content')
                            ...
                            <div class="border p-3 rounded">
                                ...
                                <form id="formulario" class="row g-3" method="POST" action="">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input id="pagina" name="pagina" class="form-control"></input>
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="date" id="fechaRegistro" name="fechaRegistro" class="form-control"></input>
                                    </div>
                                    <div class="col-12">
    ...
    <h6 class="mb-0 text-uppercase">Lista de Proveedores</h6>
    <hr>
    <div class="card">
        <div class="card-body">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            style="width: 80.094px;">Cód. Proveedor</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                            style="width: 100.094px;">Proveedor</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
