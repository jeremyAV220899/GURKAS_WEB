...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="border p-3 rounded">
                                ...
                                <form id="formulario" class="row g-3" method="POST" action="">
                                    @csrf
                                    <div class="col-4">
                                        <label class="form-label">Cod. Utiles Aseo</label>
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input id="fechaFabricacion" name="fechaFabricacion" type="date" class="form-control">
                                    </div>  
                                    <div class="col-3">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Utiles de Aseo</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <h6 class="mb-0 text-uppercase">Lista de Utiles de Aseo</h6>
    <hr>
    <div class="card">
        <div class="card-body">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            style="width: 80.094px;">Cód. Utiles Aseo</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
