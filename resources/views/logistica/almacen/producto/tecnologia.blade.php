...
@section('content')
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Registrar Producto Tecnológico</h5>
                            ...
                            <div class="border p-3 rounded">
                                ...
                                <form id="formulario" class="row g-3" method="POST" action="">
                                    ...
                                    <div class="col-2">
                                        ...
                                        <input id="codProducto" name="codProducto" type="text" class="form-control">
                                    </div>
                                    <div class="col-4">
    ...
    <h6 class="mb-0 text-uppercase">Lista de equipos tecnológicos</h6>
    <hr>
    <div class="card">
        <div class="card-body">
                            ...
                            <table id="example2" class="table table-striped table-bordered dataTable tablaUnidad"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                            style="width: 100.094px;">Nombre del equipo</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Office: activate to sort column ascending"
                                            style="width: 112.406px;">Modelo</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Age: activate to sort column ascending"
                                            style="width: 49.8594px;">Marca</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Age: activate to sort column ascending"
