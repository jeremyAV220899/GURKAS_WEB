        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Registrar Camisa</h5>
                        ...
                        <div class="card-body">
                            <div class="border p-3 rounded">
                                ...
                                <form id="formulario" class="row g-3" method="POST" action="">
                                    @csrf
                                    <div class="col-2">
                                        <label class="form-label">Cod. Camisa</label>
                                        <input id="codCamisa" name="codCamisa" type="text" class="form-control">
                                    </div>
                                    <div class="col-4">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Camisa</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            style="width: 80.094px;">Cód. Camisa</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
