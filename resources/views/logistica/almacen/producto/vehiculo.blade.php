...
@section('content')
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Registrar Vehicular</h5>
                        ...
                        <div class="card-body">
                            <div class="border p-3 rounded">
                                ...
                                <form id="formulario" class="row g-3" method="POST" action="">
                                    @csrf
                                    <div class="col-3">
                                        <label class="form-label">Cod. Vehiculo</label>
                                        <input id="codVehiculo" name="codVehiculo" type="text" class="form-control">
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input id="aFabricacion" name="aFabricacion" type="text"
                                            class="form-control">
                                    </div> 
                                    <div class="col-3">
    ...
    <h6 class="mb-0 text-uppercase">Lista de Vehiculos</h6>
    <hr>
    <div class="card">
        <div class="card-body">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            style="width: 80.094px;">Cód. Vehiculo</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            style="width: 49.8594px;">N° Placa</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Age: activate to sort column ascending"
