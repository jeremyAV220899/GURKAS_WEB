...
@section('content')
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Registrar Utiles de Aseo</h5>
                        ...
                        <div class="card-body">
                            <div class="border p-3 rounded">
                                ...
                                <form id="formulario" class="row g-3" method="POST" action="">
                                    @csrf
                                    <div class="col-4">
                                        <label class="form-label">Cod. Armamento</label>
                                        <input id="codutil" name="codutil" type="text" class="form-control">
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-4">
                                        <label class="form-label">Numero Serial</label>
                                        <input id="nSerial" name="nSerial" type="text" class="form-control">
                                    </div>      
                                    <div class="col-4">
                                        <label class="form-label">N° Tarjeta Propiedad</label>
                                        <input id="nSerial" name="nSerial" type="text" class="form-control">
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <select id="tipoTela" name="tipoTela" class="form-select"
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Armamento</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <h6 class="mb-0 text-uppercase">Lista de Armamento</h6>
    <hr>
    <div class="card">
        <div class="card-body">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            style="width: 80.094px;">Cód. Armamento</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                            style="width: 100.094px;">Nombre</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Office: activate to sort column ascending"
                                            style="width: 112.406px;">Marca</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
