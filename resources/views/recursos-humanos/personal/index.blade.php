...
@section('content')
    ...
    <div class="modal fade" id="registrarLaborales" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <div class="table-actions d-flex align-items-center fs-6">
                                                    ...
                                                    <button class="btn text-dark btnLaboral" type="button"
                                                        data-id="{{ $personal->id }}" data-bs-toggle="modal"
                                                        data-bs-target="#registrarLaborales" title="Laborales">
